...
class ProductoSchema(ma.Schema):
    class Meta:
        fields=('id','nombre','precio','stock','tipo','caracteristicas','peso','altura','imagen')
...
def create_producto():
    ...
    new_producto=Producto(nombre,precio,stock,tipo,caracteristicas,peso,altura,imagen)
...
def update_producto(id):
    ...
    producto.caracteristicas=request.json['caracteristicas']
    producto.peso=request.json['peso']
    producto.altura=request.json['altura']
