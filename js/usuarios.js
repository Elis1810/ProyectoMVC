...
createApp({
    data() {
        return {
            usuarios: [],           
            url: 'https://eli24177x.pythonanywhere.com/usuarios',
            error: false,
            cargando: true,
            /*alta*/
            id: 0,
    ...
    methods: {
        ...
        eliminar(id) {
            const url = 'https://eli24177x.pythonanywhere.com/usuarios/' + id;
            var options = {
                method: 'DELETE',
            }
            fetch(url, options)
        ...
        grabar() {
            let usuario = {
                ...
                clave: this.clave,
                rol: 0,/*this.rol modicicar esta linea*/
            }
            var options = {
